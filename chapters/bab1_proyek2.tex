...
Ruang lingkup dokumentasi pada proyek ini mencakup perancangan dan implementasi Sistem Informasi Peminjaman Sarana dan Prasarana yang diterapkan pada lingkungan kampus ULBI. Adapun batasan ruang lingkup sistem yang dikembangkan meliputi:
\begin{enumerate}
    \item Pengembangan sistem peminjaman sarana dan prasarana kampus yang mendukung proses pengajuan peminjaman oleh mahasiswa, proses verifikasi dan persetujuan oleh pihak sarana dan prasarana (Sarpras), serta pencatatan kehadiran peminjam oleh petugas keamanan.
    \item Pengelolaan data inventaris sarana dan prasarana yang meliputi proses penambahan data, perubahan data, dan penghapusan data inventaris yang digunakan dalam sistem peminjaman.
    \item Implementasi fitur pendukung berupa sistem autentikasi pengguna berdasarkan peran (role) yang terdiri dari mahasiswa, petugas sarana dan prasarana, serta petugas keamanan.
    \item Implementasi sistem notifikasi berbasis email sebagai media penyampaian informasi terkait status pengajuan peminjaman kepada pengguna sistem.
    \item Sistem yang dikembangkan tidak mencakup proses pengadaan sarana dan prasarana, manajemen stok barang secara menyeluruh, serta integrasi dengan sistem eksternal kampus lainnya.
\end{enumerate}
