...
\subsection{Metode Scrum}
Scrum adalah kerangka kerja (\textit{framework}) pengembangan perangkat lunak berbasis Agile yang dirancang untuk menangani proyek-proyek kompleks dengan kebutuhan yang dinamis. Scrum menerapkan pendekatan iteratif dan inkremental, di mana pengembangan sistem dibagi menjadi beberapa siklus pendek yang disebut \textit{Sprint}. Pendekatan ini memungkinkan tim pengembang untuk beradaptasi dengan cepat terhadap perubahan kebutuhan pengguna selama proses pengembangan berlangsung \parencite{Nugraha2021}.


Berdasarkan landasan teori yang telah diuraikan, sistem informasi peminjaman sarana dan prasarana kampus dianalisis dan dirancang dengan mengacu pada konsep sistem informasi, website, operasi CRUD, pengelolaan basis data menggunakan RDBMS, serta metode pengembangan Scrum. Landasan teori ini menjadi dasar dalam penyusunan analisis kebutuhan dan perancangan sistem yang dibahas pada bab selanjutnya.
