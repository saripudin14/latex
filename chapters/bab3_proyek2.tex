...
\begin{table}[htbp]
    ...
    \makebox[\textwidth][c]{
    \begin{tabularx}{1.1\textwidth}{|c|l|l|l|X|}
        \hline
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{gambar/media/image12.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{gambar/media/image13.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{gambar/media/image14.png}
