...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{gambar/media/image18.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{gambar/media/image22.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{gambar/media/image23.png}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{|c|l|c|}
        ...
        \hline
        1. & auth\_service.go & 83.3\% \\
        \hline
        2. & code\_generator.go & 100\% \\
        \hline
        3. & kehadiran\_service.go & 83.3\% \\
        \hline
        4. & peminjaman\_service.go & 34.7\% \\
        \hline
        5. & export\_service.go & 0.0\% \\
        \hline
        \multicolumn{2}{|c|}{\textbf{Total Coverage}} & \textbf{31.9\%} \\
        \hline
    \end{tabular}
\end{table}
